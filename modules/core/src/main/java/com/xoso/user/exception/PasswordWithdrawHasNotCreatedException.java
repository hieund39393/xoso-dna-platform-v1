...
public class PasswordWithdrawHasNotCreatedException extends AbstractAppException {

    public PasswordWithdrawHasNotCreatedException() {
        super(ExceptionCode.PASSWORD_WITHDRAW_NOT_CREATED);
    }
}